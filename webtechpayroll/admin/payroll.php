                ...
                <form method="POST" class="form-inline" id="payForm">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control pull-right col-sm-8" id="reservation" name="date_range" value="<?php echo (isset($_GET['range'])) ? $_GET['range'] : $range_from.' - '.$range_to; ?>">
                                    ...
                                    <button type="button" class="btn btn-success btn-sm btn-flat" id="payslip"><span class="glyphicon glyphicon-print"></span> Payslip</button>
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $sql = " SELECT employees.id as employee_id,employees.employee_id as empid,firstname,lastname,rate,num_hr,absent,late,halfday from attendance inner join employees on attendance.employee_id = employees.employee_id inner join position on position.id = employees.position_id
